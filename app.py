...
def procesar_cv():
    ...
    if archivo_pdf:
        ...
        2. Estructura exacta del JSON:
           ...
           - "experiencia_profesional": (Array de Objetos) Cada objeto debe contener las claves "cargo" (String), "empresa" (String), "ubicacion_fechas" (String) y "tareas" (Array de Strings).
